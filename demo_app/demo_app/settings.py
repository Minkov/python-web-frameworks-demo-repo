...
SECRET_KEY = 'django-insecure-m1fmi0(__$o7vo9eg3$d=1!_#z7(7k@gv_zxuoj535^_bs97uk'
...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'python-web-frameworks-demo-app.herokuapp.com',
]
...
STATIC_ROOT = os.path.join(BASE_DIR_2, 'static')
STATIC_URL = '/static/'
